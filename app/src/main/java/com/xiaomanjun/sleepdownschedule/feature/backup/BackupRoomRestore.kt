...
import com.xiaomanjun.sleepdownschedule.glass.ui.MulticolorCourseCardArgb
        ...
        val configRows = schedules.map { schedule ->
            ...
            ScheduleConfigEntity(
                ...
                courseCardColorMode = if (
                    ...
                    config.courseCardColorMode == CourseCardColorMode.SOLID.name
                ) {
                    CourseCardColorMode.COLORFUL
                } else {
                    strictBackupEnum<CourseCardColorMode>(
                ...
                alternateCourseCardColorMode = if (
                    config.alternateCardColorArgb == MulticolorCourseCardArgb &&
                    config.alternateCourseCardColorMode == CourseCardColorMode.SOLID.name
                ) {
                    CourseCardColorMode.COLORFUL
                } else {
                    strictBackupEnum<CourseCardColorMode>(
