...
- 诊断 counter、实验边界、测试与后续启用门槛见 `docs/performance/LIQUID_GLASS_FRAMEWORK.md`。当前设备仍只安装了上一版同时开启阶段二与阶段三开关的受控 Release；本次精确 Issue #70 版本仅构建，未安装、启动或操作，后续真机性能/视觉测试仍需用户明确要求。
